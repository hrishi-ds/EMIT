...
# Save data.
events.to_csv('../../data/pre_processed/mimic_iii_events.csv', index=False)
icu.to_csv('../../data/pre_processed/mimic_iii_icu.csv', index=False)
...
events = pd.read_csv('../../data/pre_processed/mimic_iii_events.csv', usecols=['HADM_ID', 'ICUSTAY_ID', 'CHARTTIME', 'VALUENUM', 'TABLE', 'NAME'])
icu = pd.read_csv('../../data/pre_processed/mimic_iii_icu.csv')
...
# Save data.
pickle.dump([events, oc, train_ind, valid_ind, test_ind], open('../../data/pre_processed/mimic_iii_preprocessed.pkl','wb'))

# Normalize data and save. 
ts, oc, train_ind, valid_ind, test_ind = pickle.load(open('../../data/pre_processed/mimic_iii_preprocessed.pkl','rb'))
...
pickle.dump([ts, oc, train_ind, valid_ind, test_ind], open('../../data/pre_processed/mimic_iii_preprocessed.pkl','wb'))