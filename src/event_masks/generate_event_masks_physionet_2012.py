...
def generate_event_masks(threshold=0.01, insignificant_prob=0.7):
    ...
    np.savez(f"../../data/pre_training/physionet_event_masks_threshold_{threshold}_insignificant_prob_{insignificant_prob}.npz",
             fore_train_masks=fore_train_masks, fore_val_masks=fore_val_masks)

    print(f"physionet_event_masks_threshold_{threshold}_insignificant_prob_{insignificant_prob}.npz saved")
